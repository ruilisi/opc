...
const translations = {
  en: {
    ...
    invite_expires_label: 'Expires after',
    invite_expires_1h: '1 hour',
    invite_expires_24h: '1 day',
    invite_expires_7d: '7 days',
    invite_expires_30d: '30 days',
    invite_max_uses_label: 'Max uses (leave blank for unlimited)',
    invite_regenerate: 'New link',
    // Kanban column
  ...
  zh: {
    ...
    invite_expires_label: '有效期',
    invite_expires_1h: '1 小时',
    invite_expires_24h: '1 天',
    invite_expires_7d: '7 天',
    invite_expires_30d: '30 天',
    invite_max_uses_label: '最多使用次数（留空则不限）',
    invite_regenerate: '重新生成',
    // Kanban column
