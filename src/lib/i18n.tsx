...
const translations = {
  en: {
    ...
    board_add_column_submit: 'Create',
    board_add_column_cancel: 'Cancel',
  ...
  zh: {
    ...
    board_add_column_submit: '创建',
    board_add_column_cancel: '取消',
